---
topic: "IntelliJ http Client 응답값 변수로 저장하고 사용하기"
source_type: other
source_url: "https://jojoldu.tistory.com/366"
authorship: self
...
![question](https://t1.daumcdn.net/cfile/tistory/99B4603F5C20451134)
...
![okky1](https://t1.daumcdn.net/cfile/tistory/9908823C5C20451137)

로그인 버튼을 클릭할 경우 아래와 같은 요청값으로 로그인이 시도됩니다.

![okky2](https://t1.daumcdn.net/cfile/tistory/99A8C3475C2045122F)

정리하면 OKKY에서 로그인을 위해선 아래 값들이 필요합니다.

- URL
  - [https://okky.kr/j\_spring\_security\_check](https://okky.kr/j_spring_security_check)
- Content-Type
...
![okky3](https://t1.daumcdn.net/cfile/tistory/99879E505C2045112F)
...
![okky4](https://t1.daumcdn.net/cfile/tistory/99833E3D5C20451137);

그리고 이 쿠키는 정상적으로 로그인했을 경우 응답값으로 받을 수 있습니다.

![okky5](https://t1.daumcdn.net/cfile/tistory/99C4023F5C2045112C);

그럼 OKKY의 로그인이 필요한 기능들은 모두 다 저 **쿠키 값을 헤더에 가진채로 요청하면 사용가능하다** 는 의미가 되겠죠?

자 그럼 IntelliJ의 `.http`파일을 하나 생성하고 아래와 같이 코드를 입력해봅니다.

![http1](https://t1.daumcdn.net/cfile/tistory/994980355C20451133)
...
![http2](https://t1.daumcdn.net/cfile/tistory/990CBF4A5C20451106)

이 응답 결과를 파싱해서 저장시켜보겠습니다.

좀 전의 코드를 아래와 같이 수정해봅니다.

![http3](https://t1.daumcdn.net/cfile/tistory/99BE573A5C2045113B)
...
![http4](https://t1.daumcdn.net/cfile/tistory/9966E74D5C20451135)

콘솔 바로 위에 있는 탭 중 **Response Handler** 탭을 클릭해보시면 아래와 같이 핸들러 스크립트에서 작성한 `client.log`가 잘 출력되고 있음을 확인할 수 있습니다.

![http5](https://t1.daumcdn.net/cfile/tistory/99FE213D5C20451104)
...
OKKY의 사용자 정보 수정 페이지 ([https://okky.kr/user/edit](https://okky.kr/user/edit))는 로그인 되지 않았을때는 오류를 발생시키죠?
...
![http6](https://t1.daumcdn.net/cfile/tistory/9941B03C5C20451102)
...
![http7](https://t1.daumcdn.net/cfile/tistory/9975DD495C20451103)

---
topic: "메일 내용 단위 테스트 하기"
source_type: other
source_url: "https://jojoldu.tistory.com/619"
authorship: self
...
![template variable image](https://blog.kakaocdn.net/dna/duX2zv/btrmYdx9sfl/AAAAAAAAAAAAAAAAAAAAABKOxpUMjBBDCFaHA-hLpWJBuCb5Wg1XVM8U-pDOPfAF/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=NLG7dA1R9RzjTSuLNvbAM%2Fv8Sdw%3D)

템플릿 데이터에서는 아직 `userName` 으로 그대로 두고 발견하지 못한채 배포를 해버릴 수도 있다.

![code variable image](https://blog.kakaocdn.net/dna/cShuja/btrmYc64sgi/AAAAAAAAAAAAAAAAAAAAAIF_wfCLJX1rD6w140v7_oY92lSlrv8RMRwNcRyt3S8M/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=dQnhd4neHeWLejsJ305nVVaDl%2Fw%3D)

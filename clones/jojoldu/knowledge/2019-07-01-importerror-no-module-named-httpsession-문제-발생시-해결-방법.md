---
topic: "ImportError: No module named httpsession 문제 발생시 해결 방법"
source_type: other
source_url: "https://jojoldu.tistory.com/426"
authorship: self
...
![1](https://t1.daumcdn.net/cfile/tistory/9975CF3E5D1A0A5B05)
...
보통 젠킨스를 실행할때 ec2-user 그대로 실행하진 않습니다. (거의 root와 비슷한 권한을 갖고 있기 때문이죠)
...
![2](https://t1.daumcdn.net/cfile/tistory/99B6B3505D1A0A5A21)

그럼 다시 해당 젠킨스 Job을 실행해보면 정상적으로 되는 것을 확인할 수 있습니다.

![3](https://t1.daumcdn.net/cfile/tistory/99DCD33B5D1A0A5A1A)

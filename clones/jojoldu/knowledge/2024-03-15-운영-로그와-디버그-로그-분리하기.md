---
topic: "운영 로그와 디버그 로그 분리하기"
source_type: other
source_url: "https://jojoldu.tistory.com/773"
authorship: self
...
> 최근에 [Pete Hodgson](https://blog.thepete.net/about/) 가 [martinfowler 블로그에 기재한 글](https://martinfowler.com/articles/domain-oriented-observability.html) 을 보면서 **로깅도 하나의 기능** 으로 봐야한다는 생각이 더 강해져서 이 글을 쓰게 되었다.

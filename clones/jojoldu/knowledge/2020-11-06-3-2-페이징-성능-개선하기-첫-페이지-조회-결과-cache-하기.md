---
topic: "3-2. 페이징 성능 개선하기 - 첫 페이지 조회 결과 cache 하기"
source_type: other
source_url: "https://jojoldu.tistory.com/531"
authorship: self
...
![query_cache](https://t1.daumcdn.net/cfile/tistory/99B6CF455FA51F2D29)
...
![test_1](https://t1.daumcdn.net/cfile/tistory/998672445FA51F2D28)
...
@Test
void cache가_없으면_실제_count를_사용한다() throws Exception {
    PageRequest pageRequest = PageRequest.of(1, 10);
...
![test_2](https://t1.daumcdn.net/cfile/tistory/996573375FA51F2D23)

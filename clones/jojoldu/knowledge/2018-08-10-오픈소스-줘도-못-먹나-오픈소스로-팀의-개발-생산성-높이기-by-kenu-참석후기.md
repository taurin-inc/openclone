---
topic: "오픈소스, 줘도 못 먹나 - 오픈소스로 팀의 개발 생산성 높이기 by kenu 참석후기!"
source_type: other
source_url: "https://jojoldu.tistory.com/327"
authorship: self
...
![발표자소개](https://t1.daumcdn.net/cfile/tistory/99D2EA485B6CC4641A)
...
- 저도 기여하고 싶어요
  ...
  - 설정 튜닝
  - 이슈 등록
  - 문서 번역 [kenu.github.io/tomcat70/docs](https://kenu.github.io/tomcat70/docs)
  - Fork, Pull Request
...
- Git
  - [상황별 Git 커맨드 정리](https://okdevtv.com/mib/git/status)

---
topic: "Spring Batch JpaCursorItemReader 도입 및 사용법"
source_type: other
source_url: "https://jojoldu.tistory.com/551"
authorship: self
...
![intro](https://t1.daumcdn.net/cfile/tistory/99919E42600E43FF18)
...
```java
@Slf4log // log 사용을 위한 lombok 어노테이션
...
Cursor 방식이 스트리밍이기 때문에 한번에 몇개의 데이터를 읽어올지를 결정하는 `pageSize` 는 Cursor에서 필요가 없습니다.

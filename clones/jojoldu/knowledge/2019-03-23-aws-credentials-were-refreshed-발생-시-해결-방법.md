---
topic: "AWS Credentials were refreshed 발생 시 해결 방법"
source_type: other
source_url: "https://jojoldu.tistory.com/410"
authorship: self
...
![update1](https://t1.daumcdn.net/cfile/tistory/998416365C95B78F2B)
...
![check](https://t1.daumcdn.net/cfile/tistory/99CAFD4B5C95B78F01)

정상적으로 cli가 실행됐다면, 최종적으로 key 등록까지 확인합니다.

아래와 같이 **iam-role** 로 저장되어있는게 확인되면 정상적으로 갱신된 것입니다.

![check2](https://t1.daumcdn.net/cfile/tistory/990CDC435C95B78F01)

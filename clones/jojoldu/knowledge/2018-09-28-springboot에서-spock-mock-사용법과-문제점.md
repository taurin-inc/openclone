---
topic: "SpringBoot에서 Spock Mock 사용법과 문제점"
source_type: other
source_url: "https://jojoldu.tistory.com/340"
authorship: self
...
그러다보니 **Spock을 쓴다 해도 Spring의 Bean을 Mocking하려면 Mockito** 방식을 사용해야 합니다.
...
하지만 이럴 경우 **Overloading Method를 Mocking 해야할때 문제** 가 발생합니다.

![spock_mock실패](https://t1.daumcdn.net/cfile/tistory/99808B335BAD740E0F)
...
![junit_mock성공](https://t1.daumcdn.net/cfile/tistory/9955793C5BAD740D12)
...
하지만 이 경우에도 문제가 있습니다 ㅠㅠㅠ

## Spock Spring Mock의 문제점

Spring-data-jpa에서 제공하는 JpaRespotiroy 인터페이스는 Mocking 하지 못합니다.

**JPA가 cglib 프록시를 생성하면서 Spock이 Mock으로 생성한 프록시를 무시** 하기 때문입니다.

![mock실패](https://t1.daumcdn.net/cfile/tistory/995D7F365BAD740D0B)

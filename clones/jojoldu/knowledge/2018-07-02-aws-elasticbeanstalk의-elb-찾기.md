---
topic: "AWS ElasticBeanstalk의 ELB 찾기"
source_type: other
source_url: "https://jojoldu.tistory.com/312"
authorship: self
published_at: 2018-07-02
---
# AWS ElasticBeanstalk의 ELB 찾기

**by 향로 (기억보단 기록을) 2018. 7. 2.**
...
(이 방법은 **EC2를 찾을때도 동일하게 사용** 됩니다.)

## 본문

아래와 같이 ElasticBeanstalk의 Environment 메인화면을 보면 **Environment ID** 가 있습니다.

![1](https://t1.daumcdn.net/cfile/tistory/99B7744F5B3A174015)

이 값을 복사하고, Load Balancer 서비스로 이동합니다.

검색창에 `env`만 입력하시면, 아래처럼 추천검색어가 나오는데요.

![2](https://t1.daumcdn.net/cfile/tistory/99A484495B3A174002)

여기서 `environment-id`를 선택합니다.

그리고 다음 값에 EB에서 복사한 **Environment ID** 을 입력합니다.

![3](https://t1.daumcdn.net/cfile/tistory/998C50365B3A174011)

그리고 `Enter`를 치시면!

![4](https://t1.daumcdn.net/cfile/tistory/992EF0425B3A17402D)

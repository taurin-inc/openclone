---
topic: "Dto 클래스에서 MultiValueMap로 쉽게 타입 변환하기"
source_type: other
source_url: "https://jojoldu.tistory.com/478"
authorship: self
published_at: 2020-02-23
---
# Dto 클래스에서 MultiValueMap로 쉽게 타입 변환하기

by 향로 (기억보단 기록을) 2020. 2. 23.
...
![mvm1](https://t1.daumcdn.net/cfile/tistory/99FA4F505E525DBB2F)

이렇게 Value(`V`) 가 사실은 `List<V>` 에 사용되는 것을 알 수 있습니다.

실제로 `add` 로 단일값을 넣을때면 기존의 값이 없는 Key가 들어올 경우 List를 만들어 단일값을 추가하도록 되어있습니다.

![mvm2](https://t1.daumcdn.net/cfile/tistory/9922E53C5E525DBB30)
...
![why-mvm](https://t1.daumcdn.net/cfile/tistory/99C4E6425E525DBB30)
...
![test1](https://t1.daumcdn.net/cfile/tistory/99D467345E525DBB08)
...
![test2](https://t1.daumcdn.net/cfile/tistory/995D71415E525DBB33)

**@JsonProperty** 로 변경된 필드명으로 잘 변환된 것을 확인할 수 있습니다.

마지막으로 전체 테스트를 실행해보겠습니다.

![all-test](https://t1.daumcdn.net/cfile/tistory/999FFB415E525DBB38)

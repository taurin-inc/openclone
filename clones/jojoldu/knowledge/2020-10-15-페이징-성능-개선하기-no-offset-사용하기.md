---
topic: "페이징 성능 개선하기 - No Offset 사용하기"
source_type: other
source_url: "https://jojoldu.tistory.com/528"
authorship: self
published_at: 2020-10-15
---
# 1. 페이징 성능 개선하기 - No Offset 사용하기

**by 향로 (기억보단 기록을) 2020. 10. 15.**
...
![legacy_pagination](https://t1.daumcdn.net/cfile/tistory/99BA46385F88473C29)

No Offset은 아래와 같이 **페이지 번호 (offset)가 없는** 더보기 (More) 방식을 이야기 합니다.

![more_btn](https://t1.daumcdn.net/cfile/tistory/99E1A2455F88473D2F)

페이스북과 같은 대량의 데이터를 다루는 **SNS의 게시글 조회 오픈 API** 를 사용해보신 분들은 그와 **비슷** 하다고 보시면 됩니다.

(내부 구조를 모르기 때문에 **동일하다고 확답을 드릴순 없습니다**.)

![facebook](https://t1.daumcdn.net/cfile/tistory/99C7FC455F88473D2C)
...
![nooffset_intro](https://t1.daumcdn.net/cfile/tistory/99C80C475F88473D25)
...
![nooffset_1](https://t1.daumcdn.net/cfile/tistory/99812E4B5F88473D2C)![nooffset_2](https://t1.daumcdn.net/cfile/tistory/991A944B5F88473C26)
...
![result_legacy](https://t1.daumcdn.net/cfile/tistory/999DD1375F88473D22)
...
*   테스트 DB: AWS RDS Aurora MySQL r5.large
*   테스트 테이블: 1억 row, 5개 컬럼

**기존 페이징**
![query_legacy](https://t1.daumcdn.net/cfile/tistory/9921AF495F88473D24)

**NoOffset**
![query_nooffset](https://t1.daumcdn.net/cfile/tistory/99BD36375F88473D2A)
...
*   where에 사용되는 **기준 Key가 중복이 가능할 경우**: 이를 테면 `group by` 등으로 기준으로 잡을 Key가 중복이 될 경우 정확한 결과를 반환할 수 없어서 사용할 수가 없습니다.

---
topic: "PostgreSQL 데이터 Client에서 KST로 확인하기 (feat. DataGrip)"
source_type: other
source_url: "https://jojoldu.tistory.com/567"
authorship: self
...
![1](https://t1.daumcdn.net/cfile/tistory/995E8A466083D7602A)

(현재 한국 시간은 2021-04-24 10:19:06 입니다.)

실제 적재된 테이블의 컬럼값을 확인해도 아래와 같이 **UTC** 값 그대로 노출되는 것을 볼 수 있습니다.

![2](https://t1.daumcdn.net/cfile/tistory/9996A8486083D76029)
...
![3](https://t1.daumcdn.net/cfile/tistory/99EA4B436083D7602A)

DataGrip에서는 `해당 DataSource 설정` -> `Options` -> `Time zone` 항목으로 이동하여 `Asia/Seoul` 을 등록하시면됩니다.

![4](https://t1.daumcdn.net/cfile/tistory/996945356083D7602B)
...
![5](https://t1.daumcdn.net/cfile/tistory/9901CA3A6083D7602C)

테이블의 데이터까지 정상적으로 KST가 적용된 것을 확인할 수 있습니다.

![6](https://t1.daumcdn.net/cfile/tistory/9901D43A6083D7602C)

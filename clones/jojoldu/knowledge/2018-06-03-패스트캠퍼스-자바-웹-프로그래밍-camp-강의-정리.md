---
topic: "패스트캠퍼스 자바 웹 프로그래밍 CAMP 강의 정리"
source_type: other
source_url: "https://jojoldu.tistory.com/301"
authorship: self
published_at: 2018-06-03
---
# 패스트캠퍼스 자바 웹 프로그래밍 CAMP 정리

by 향로 (기억보단 기록을) 2018. 6. 3.

2016.07 ~ 2016.08 진행

- 자바지기(박재성)님의 패스트캠퍼스 자바 웹 프로그래밍 CAMP 강의 내용 정리
- 광고 아니라 진심으로 150만원 상당의 수강료가 아깝지 않은 명품 강의였다.
- 참고로 현재 박재성님은 [NextStep](https://edu.nextstep.camp/) 에서 교육하신다.
...
![messageSource config code](https://t1.daumcdn.net/cfile/tistory/99A130365B13CC1B14)
...
![MappedSuperclass](https://t1.daumcdn.net/cfile/tistory/995F323F5B13CC1B15)
...
![RestTemplate&SpringBootTest](https://t1.daumcdn.net/cfile/tistory/996F863A5B13CC1B2C)

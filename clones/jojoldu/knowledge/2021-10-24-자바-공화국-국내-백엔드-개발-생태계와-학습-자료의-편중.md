---
topic: "자바 공화국: 국내 백엔드 개발 생태계와 학습 자료의 편중"
source_type: other
source_url: "https://jojoldu.tistory.com/609"
authorship: self
...
![java](https://blog.kakaocdn.net/dna/dafRcF/btriBBQsud1/AAAAAAAAAAAAAAAAAAAAAME6abibGOh-gdb87NlZGBqL27mpDqRdgyOR6hA1sShv/img.jpg?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=dN3QoS%2Bd%2Foat1dxHbmg9VVnA8As%3D)

오늘 교보에서 주문한 [단위 테스트](https://www.kyobobook.co.kr/product/detailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9791161755748) 책을 받았다.

![unittest](https://blog.kakaocdn.net/dna/ec68F9/btriFjHU0vC/AAAAAAAAAAAAAAAAAAAAAKVfSa2y_i83bHnrHEjfnslocoDOgap5Loy4-9G_DzPb/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=XMJbiMGxreqPpWGe82%2BnyNxKyaQ%3D)

[Xunit 테스트 패턴 책](http://www.kyobobook.co.kr/product/detailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9788960771253&orderClick=LAG&Kc=#N) (번역이 나와 맞지 않았다ㅠ) 이후에 테스트와 관련해서는 되게 오랫만에 본 재밌는 책이여서 이건 우리팀 위키에 정리해서 공유해야겠다는 생각이 들었다.
...
- 패스트캠퍼스의 The Red 시리즈
  - [이규원님 강좌](https://fastcampus.co.kr/dev_red_ygw) (Java / C# / JS 예제코드가 섞여있다.)
...
- 인프런의 [영한님](https://www.inflearn.com/users/@yh) / [기선님](https://www.inflearn.com/users/@whiteship) 강의

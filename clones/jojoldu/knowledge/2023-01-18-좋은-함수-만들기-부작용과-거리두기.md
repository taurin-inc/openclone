---
topic: "좋은 함수 만들기 - 부작용과 거리두기"
source_type: other
source_url: "https://jojoldu.tistory.com/697"
authorship: self
published_at: 2023-01-18
---
# 1. 좋은 함수 만들기 - 부작용과 거리두기

by 향로 (기억보단 기록을) 2023. 1. 18.
...
![search1](https://blog.kakaocdn.net/dna/bpFAK9/btrWwICQn4R/AAAAAAAAAAAAAAAAAAAAAMny5Oo1I2vbzgZkNpSuDOuFTp2vul6qqyfSx_NTd7W7/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=WuuMkO1z5dIC3OIiZOYfM4FygmU%3D)

- [https://wiki.fluidproject.org/display/fluid/A+Good+Function](https://wiki.fluidproject.org/display/fluid/A+Good+Function)

![search2](https://blog.kakaocdn.net/dna/bW6I4i/btrWx4ZsYqs/AAAAAAAAAAAAAAAAAAAAAC4Rfd2ucJanBEuXTPjYFyiue1Wg3z9Ty0x_tV-4lyfa/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=a5W7rM0ndNBYdUi6cbLBdx1NTPE%3D)

순수함수란 무엇인지 요즘 유행하는 (?) [ChatGPT](https://chat.openai.com/chat) 에게 한번 물어보자.

![gpt](https://blog.kakaocdn.net/dna/p8gjj/btrWuODQDl2/AAAAAAAAAAAAAAAAAAAAACFIpQbnc5clZw5IhlGeuyos9SUfXxsd47GZ-fFOrkOz/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=%2FLKc6j7BP29OXLCjfAQPnOQDEhA%3D)
...
![design1](https://blog.kakaocdn.net/dna/bdzgzM/btrWx5KPMhk/AAAAAAAAAAAAAAAAAAAAAPNtrd4dStf_fPoGCaV6Oc8_vZGgk7DixFJg9u0fBJml/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=5UGHUM4jGlZNf2g9JaXRorJPogo%3D)

그렇기 때문에 부작용과 순수의 영역을 격리화시켜야만 한다.

부작용이 함수 내부에 깊게 호출되고 있다면, 이는 프로젝트 전체가 부작용으로 오염된다.

![design2](https://blog.kakaocdn.net/dna/5pHpf/btrWx6319fZ/AAAAAAAAAAAAAAAAAAAAACk0VRGw2FGAXlHNbpRABxrd7HgQxTRczIuKR8Obaeh-/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=vVPpwrysS3bjBmgYEx0T3yzlgRk%3D)

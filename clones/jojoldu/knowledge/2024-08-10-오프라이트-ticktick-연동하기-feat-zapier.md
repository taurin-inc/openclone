---
topic: "오프라이트 & TickTick 연동하기 (feat. Zapier)"
source_type: other
source_url: "https://jojoldu.tistory.com/796"
authorship: self
...
Trigger에는 TickTick App을 등록하고 Event를 `New Task Created` 로 선택하고, 본인의 TickTick 계정과 연동한다.

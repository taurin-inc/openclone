---
topic: "MultipleBagFetchException 발생시 해결 방법"
source_type: other
source_url: "https://jojoldu.tistory.com/457"
authorship: self
...
![exam1](https://t1.daumcdn.net/cfile/tistory/999087345DBE850C23)
...
![exam2](https://t1.daumcdn.net/cfile/tistory/994ECD455DBE850D19)
...
![exam3](https://t1.daumcdn.net/cfile/tistory/99B81C4E5DBE850C2B)
...
![batchsize1](https://t1.daumcdn.net/cfile/tistory/996DE3495DBE850A2E)
...
![batchsize2](https://t1.daumcdn.net/cfile/tistory/99316C415DBE850A1C)
...
![batchsize3](https://t1.daumcdn.net/cfile/tistory/993A4A4E5DBE850A21)

![batchsize4](https://t1.daumcdn.net/cfile/tistory/99701E405DBE850A1D)
...
> Tip) 보통 옵션값을 1,000 이상 주지는 않습니다. in절 파라미터로 1,000 개 이상을 주었을때 너무 많은 in절 파라미터로 인해 문제가 발생할수도 있기 때문입니다.
...
Querydsl 역시 JPQL 로 변환 작업에서 동일하게 문제가 발생합니다. JPA에서 안되는게 Querydsl에 될수는 없습니다.

다시 한번 Querydsl의 코드를 확인해보세요. 자식 엔티티와의 관계가 **OneToOne, ManyToOne** 이지 않나요?

다시 언급드리지만, Fetch Join은 **ToOne은 여러개 적용이 가능** 하지만, **ToMany와 같이 1:N 의 N에 대해서는 여러개 사용할 수 없습니다**. Querydsl 역시 **N 관계의 자식들에 대해서는 멀티 페치 조인이 안됩니다**.

![querydsl1](https://t1.daumcdn.net/cfile/tistory/99F899355DBE850A1A)

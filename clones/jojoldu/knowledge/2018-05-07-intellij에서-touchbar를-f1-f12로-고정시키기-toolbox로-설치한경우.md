---
topic: "IntelliJ에서 Touchbar를 F1 ~ F12로 고정시키기 (Toolbox로 설치한경우)"
source_type: other
source_url: "https://jojoldu.tistory.com/293"
authorship: self
published_at: 2018-05-07
---
# IntelliJ에서 Touchbar를 F1 ~ F12로 고정시키기 (Toolbox로 설치한경우)
...
![터치바](https://t1.daumcdn.net/cfile/tistory/9937793A5AF037C228)
...
(인텔리제이를 직접 받아서 쓰시는 분들은 [백투더백](http://macnews.tistory.com/5176) 을 참고해보세요! )
...
![finder](https://t1.daumcdn.net/cfile/tistory/99F6FD385AF037C12A)

그리고 `~/Library`를 입력하고 이동합니다.

![Library](https://t1.daumcdn.net/cfile/tistory/99458C3F5AF037C128)

Library 폴더로 이동하시면 화면 상단의 **파일** -> **사이드바에 추가** 를 클릭해서 사이드바에 등록합니다.

![사이드바추가1](https://t1.daumcdn.net/cfile/tistory/990CC43F5AF037C12D)

그럼 아래처럼 사이드바에 Library가 등록됩니다.

![사이드바추가2](https://t1.daumcdn.net/cfile/tistory/99980F3F5AF037C10B)
...
![키보드](https://t1.daumcdn.net/cfile/tistory/997C18355AF037C12C)
...
![Intellij선택](https://t1.daumcdn.net/cfile/tistory/995CC3345AF037C129)
...
![등록후](https://t1.daumcdn.net/cfile/tistory/991524355AF037C11F)

직접 다운받아서 설치한 툴들을 등록하고 싶으시면 **응용 프로그램** 에서 바로 등록하시면 됩니다.

![일반툴](https://t1.daumcdn.net/cfile/tistory/99E1A9435AF037C115)

자 이렇게 하시면 모든 설정이 끝납니다.

### 세팅전

![세팅전](https://t1.daumcdn.net/cfile/tistory/99DA0B4E5AF037C214)

F1 ~ F12가 없는 터치바에서

### 세팅후

![세팅후](https://t1.daumcdn.net/cfile/tistory/9917204D5AF037C220)

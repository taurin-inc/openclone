---
topic: "Mustache.js 로 이메일 템플릿 구성하기 (TypeScript)"
source_type: other
source_url: "https://jojoldu.tistory.com/618"
authorship: self
...
![string](https://blog.kakaocdn.net/dna/qhxE5/btrmkq5kBkB/AAAAAAAAAAAAAAAAAAAAAAcqwXc9CDmBQsPSzZpCN0PBhV2HuV5QIEUaA629Fugg/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=GlsuIjevOIsnBmqsvG%2Bg5uCulJc%3D)
...
![template](https://blog.kakaocdn.net/dna/b84nqA/btrmpwKsFqQ/AAAAAAAAAAAAAAAAAAAAAFX6sIHOaqKzzoKY8doyYB0A1TKS3wH1y_BbQgyN-dwG/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=HjXmFf6DqKvrUWy3lu1ySlPHa0c%3D)
...
![1](https://blog.kakaocdn.net/dna/lXhBz/btrmiE35rEp/AAAAAAAAAAAAAAAAAAAAAEZnlEL8WhwAJGay6Zn1H-E7MPDiiH4CgdHJQArlFHzV/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=w0zAf1AtekFoHwbI6rbpcI8QUCI%3D)
...
![dir](https://blog.kakaocdn.net/dna/yqqvb/btrmrvxJiK5/AAAAAAAAAAAAAAAAAAAAAE-XYXC_Ofv09xQ_qyOdpnR2Vqr6hkHM3RMbnocIJhmU/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=aPpgpM7sRS21UBkBTu%2FwbshwInk%3D)
...
둘 모두 실행해보면 테스트가 정상적으로 통과되는 것을 볼 수 있습니다.

![test](https://blog.kakaocdn.net/dna/dpDh84/btrmlX9EjUy/AAAAAAAAAAAAAAAAAAAAAEHMcWelVw1OkedwLttmAAoPh7Z8NQtY58IlkDBJtuy3/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=I5Tk6PHAIY3uK3sVF9GI5006NF4%3D)
...
*   [플러그인 (Handlebars/Mustache)](https://plugins.jetbrains.com/plugin/6884-handlebars-mustache)

설치하시면 다음과 같이 `.hbs`, `.mustache` 에서는 HTML과 동일한 코드 지원을 받을 수 있습니다.

![plugin](https://blog.kakaocdn.net/dna/HtVIR/btrmidZVF71/AAAAAAAAAAAAAAAAAAAAAOkhjM32ylZ4E7ibtaqQbY5VIScSjN1ExRg4nAcb0J6d/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=lyvg4UqFNOHFewkJa1dvBT1es4c%3D)
...
들어가보시면 다음과 같이 머스테치 마크업 코드와 데이터 코드를 넣을 수 있는 화면이 나옵니다. 양식에 맞게 채워주시면 결과물을 미리 볼 수 있습니다.

![preview](https://blog.kakaocdn.net/dna/VHMkk/btrmpxbw5QC/AAAAAAAAAAAAAAAAAAAAAMfjdhvko5G8ARZNyqI6gGBbHFwu4cd0g3ZQ2Fd11nA8/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=fmlehKabskAuSbaJI8ob1ZNSW%2F0%3D)

---
topic: "IntelliJ (Ultimate & Community)에서 스프링부트 active profile 설정하기"
source_type: other
source_url: "https://jojoldu.tistory.com/547"
authorship: self
published_at: 2021-01-14
---
# IntelliJ (Ultimate & Community) 에서 스프링부트 active profile 설정하기

**by 향로 (기억보단 기록을) 2021. 1. 14.**
...
![ij-ultimate1](https://t1.daumcdn.net/cfile/tistory/998DA03C5FFF8B3E05)

Active profiles 항목에 본인이 원하는 profiles을 입력하시면 됩니다.

![ij-ultimate2](https://t1.daumcdn.net/cfile/tistory/9906FA365FFF8B3E05)
...
![ij-community1](https://t1.daumcdn.net/cfile/tistory/99C9FD495FFF8B3E05)

스프링 부트 애플리케이션 실행 환경을 선택 하신 뒤,

![ij-community0](https://t1.daumcdn.net/cfile/tistory/9923123B5FFF8B3E05)

팝업창의 우측 상단을 보시면 `Modify options`가 있는데요.

이를 클릭 하시면 아래와 같이 리스트로 여러 옵션이 나오는데 이 중, `Add VM options`를 선택 합니다.

![ij-community2](https://t1.daumcdn.net/cfile/tistory/993EB1355FFF8B3E05)

그럼 아래와 같이 VM options 입력 항목이 추가됩니다.

![ij-community3](https://t1.daumcdn.net/cfile/tistory/998CE83E5FFF8B3E05)

여기에 아래와 같이 `-Dspring.profiles.active=원하는profile`을 추가합니다.

![ij-community4](https://t1.daumcdn.net/cfile/tistory/997675375FFF8B3E05)
...
![ij-community5](https://t1.daumcdn.net/cfile/tistory/992EBF485FFF8B3E05)

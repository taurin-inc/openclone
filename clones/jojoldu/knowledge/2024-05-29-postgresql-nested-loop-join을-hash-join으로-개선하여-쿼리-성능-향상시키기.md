---
topic: "[PostgreSQL] Nested Loop Join을 Hash Join으로 개선하여 쿼리 성능 향상시키기"
source_type: other
source_url: "https://jojoldu.tistory.com/784"
authorship: self
...
*   **Nested Loop 조인**
    ...
    *   특히, vouchers 테이블에서 user\_id 와 course\_id, deleted\_at 조건을 만족하는 행을 찾기 위해 많은 반복 작업이 필요하다.
*   **데이터 양**

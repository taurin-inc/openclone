---
topic: "[Mac] Java 21 & Gradle 8 설치하기"
source_type: other
source_url: "https://jojoldu.tistory.com/789"
authorship: self
...
설치된 jenv 를 등록하기 위해 `~/.bashrc` 또는 `~/.bash_profile` 혹은 `~/.zshrc` 에 아래 내용을 추가한다.

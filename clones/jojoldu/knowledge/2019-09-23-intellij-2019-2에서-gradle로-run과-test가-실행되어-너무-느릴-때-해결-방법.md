---
topic: "IntelliJ 2019.2에서 Gradle로 run과 test가 실행되어 너무 느릴 때 해결 방법"
source_type: other
source_url: "https://jojoldu.tistory.com/450"
authorship: self
published_at: 2019-09-23
---
# IntelliJ 2019.2 에서 Gradle로 run과 test가 실행되어 너무 느릴때

**by 향로 (기억보단 기록을) | 2019. 9. 23.**

[인프런 강의](https://www.inflearn.com/course/intellij-guide) 를 올린 뒤 최근에 받은 질문이 있습니다.

![0](https://t1.daumcdn.net/cfile/tistory/99B2BC4E5D88226807)
...
이 방식의 큰 문제는 Gradle로 수행하기 위해 **테스트 성능이 굉장히 느려진다는 것** 입니다.

**메인 메소드**

![1](https://t1.daumcdn.net/cfile/tistory/991737335D88226809)

**테스트 메소드**

![2](https://t1.daumcdn.net/cfile/tistory/993FDB335D88226808)
...
![3](https://t1.daumcdn.net/cfile/tistory/99A44D355D88226801)

2가지 항목이 모두 Gradle로 되어 있습니다.

셀렉트 박스를 선택해 IntelliJ 로 변경합니다.

![4](https://t1.daumcdn.net/cfile/tistory/994F4A4D5D88226806)

이렇게 변경 하신 뒤 다시 메인 메소드와 테스트 메소드를 실행해보시면

**메인 메소드**

![5](https://t1.daumcdn.net/cfile/tistory/99A0BB365D88226804)

**테스트 메소드**

![6](https://t1.daumcdn.net/cfile/tistory/9939D94C5D88226806)

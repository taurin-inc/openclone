---
topic: "[PostgreSQL] 모든 View 의 접근 기록 테이블에 적재하기 (애플리케이션 변경 없이)"
source_type: other
source_url: "https://jojoldu.tistory.com/742"
authorship: self
...
- `INSERT ~~` : view\_access\_log 테이블에 새 로그를 적재한다.
...
![result](https://blog.kakaocdn.net/dna/p5YQg/btszHTturHZ/AAAAAAAAAAAAAAAAAAAAAI1kWGBc6TJKyUrb3u8V8NGv8h8FKUvNFcgyWu8kEgZx/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1774969199&allow_ip=&allow_referer=&signature=8Vj9KYWDstT0r551gq4zpku2lKI%3D)

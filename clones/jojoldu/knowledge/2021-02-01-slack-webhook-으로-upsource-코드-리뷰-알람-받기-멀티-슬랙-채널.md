---
topic: "Slack webhook 으로 Upsource 코드 리뷰 알람 받기 (멀티 슬랙 채널)"
source_type: other
source_url: "https://jojoldu.tistory.com/553"
authorship: self
...
![webhook4](https://t1.daumcdn.net/cfile/tistory/9966DC3760177B500E)
...
![intro](https://t1.daumcdn.net/cfile/tistory/99E9313A60177B510E)
...
![upsource-api1](https://t1.daumcdn.net/cfile/tistory/99A6204960177B510E)

클릭해보시면 아래와 같이 JSON 정보를 볼 수 있는데요.

상세 정보를 담고 있는 `base` 필드 항목을 살펴봅니다.

![upsource-api2](https://t1.daumcdn.net/cfile/tistory/9916A03B60177B510E)

그럼 아래와 같이 `base` 필드에 정보들이 담겨있는 것을 볼 수 있습니다.

![upsource-api3](https://t1.daumcdn.net/cfile/tistory/99E9AB4760177B510E)
...
![lambda1](https://t1.daumcdn.net/cfile/tistory/994AF83C60177B500D)
...
![lambda2](https://t1.daumcdn.net/cfile/tistory/9916A93B60177B510E)

그럼 아래와 같이 Lambda가 생성이 되는데요.

![lambda3](https://t1.daumcdn.net/cfile/tistory/996C6B4460177B510D)
...
![lambda4](https://t1.daumcdn.net/cfile/tistory/99A27F4B60177B500E)
...
![lambda5](https://t1.daumcdn.net/cfile/tistory/99E93B3A60177B530E)
...
![lambda6](https://t1.daumcdn.net/cfile/tistory/990D884360177B510D)

실제 Upsource에서 넘겨줄 JSON 데이터를 임의로 만들어서 Lambda를 실행해보겠습니다.

![lambda7](https://t1.daumcdn.net/cfile/tistory/9916973B60177B510E)
...
![lambda8](https://t1.daumcdn.net/cfile/tistory/99168B3360177B500D)

테스트를 수행해보시면?

정상적으로 슬랙으로 메세지가 간 것을 볼 수 있습니다.

![lambda9](https://t1.daumcdn.net/cfile/tistory/99458E4660177B510D)
...
![api1](https://t1.daumcdn.net/cfile/tistory/9966F53760177B510E)

여기서 여러 형태가 선택 가능한데, 저희는 REST API를 선택합니다.

![api2](https://t1.daumcdn.net/cfile/tistory/996F004860177B510E)

신규 API에 대한 각 항목들을 채웁니다.

![api3](https://t1.daumcdn.net/cfile/tistory/99E9283A60177B510E)
...
![api4](https://t1.daumcdn.net/cfile/tistory/993AA03560177B510D)

Upsource에서 POST로 JSON을 넘겨 주기 때문에 API Gateway도 POST를 선택합니다.

![api5](https://t1.daumcdn.net/cfile/tistory/993AA53560177B510D)

해당 Gateway 호출 시, 실행시킬 기능을 설정하는데요.

저희는 이미 만들어둔 Lambda가 있으니 해당 Lambda 정보를 사용합니다.

![api6](https://t1.daumcdn.net/cfile/tistory/99457C4660177B500D)
...
![api7](https://t1.daumcdn.net/cfile/tistory/99F1B54560177B510D)

여기서는 **어떤 쿼리 파라미터를 등록할 것인지** 설정할 수 있는데요.

Lambda 코드에서도 말씀드렸듯이, **어떤 슬랙 채널로 보낼지 웹훅 주소** 를 쿼리 파라미터로 받겠습니다.

![api8](https://t1.daumcdn.net/cfile/tistory/9945894660177B510D)
...
![api9](https://t1.daumcdn.net/cfile/tistory/996EED4860177B500E)

통합 요청 항목을 클릭하면 아래와 같이 매핑 템플릿을 볼 수 있는데요.

여기서 **매핑 템플릿 추가** 를 클릭합니다.

![api10](https://t1.daumcdn.net/cfile/tistory/994AFD3C60177B500D)

그럼 아래와 같이 신규 `Content-Type` 으로 `application/json`을 등록합니다.

![api11](https://t1.daumcdn.net/cfile/tistory/9966E93760177B500E)

등록 하게 되면 팝업이 뜨는데 이때는 **예, 이 통합 보호** 를 선택하시면 됩니다.

![api12](https://t1.daumcdn.net/cfile/tistory/99A6294960177B510E)

그럼 아래와 같이 **API Gateway로 넘어온 값들을 Lambda Json으로 어떻게 넘겨줄지** 정리할 수 있는데요.

> 문법은 [Apache Velocity](https://velocity.apache.org/) 입니다.

![api13](https://t1.daumcdn.net/cfile/tistory/99E91F3A60177B510E)
...
![api-test1](https://t1.daumcdn.net/cfile/tistory/9969763660177B510D)

먼저 실제 URL 쿼리 파라미터로 넘어올 `webhook` 항목과 Upsource에서 넘겨줄 JSON Body를 함께 채워줍니다.

![api-test2](https://t1.daumcdn.net/cfile/tistory/994B023C60177B510D)
...
![api-test3](https://t1.daumcdn.net/cfile/tistory/99F48C4A60177B510E)

실제 슬랙으로도 알람이 잘 오는 것을 볼 수 있습니다.

![api-test4](https://t1.daumcdn.net/cfile/tistory/9911D83360177B510E)
...
![api-deploy1](https://t1.daumcdn.net/cfile/tistory/9984AD3860177B500E)

등장하는 팝업에서 본인이 원하는 환경명 (저는 `prod`) 를 등록하신 뒤, 생성하시면 됩니다.

![api-deploy2](https://t1.daumcdn.net/cfile/tistory/99168F3B60177B500E)

그럼 아래와 같이 **외부에서 호출 가능한 엔드포인트**(URL)이 생성됩니다.

![api-deploy3](https://t1.daumcdn.net/cfile/tistory/993A9B3560177B510D)
...
![webhook1](https://t1.daumcdn.net/cfile/tistory/99697B3660177B500D)

코드리뷰 알람을 받고자 하는 프로젝트의 **Edit project** 를 클릭합니다.

![webhook2](https://t1.daumcdn.net/cfile/tistory/9984B33860177B500E)

그럼 설정 페이지가 나오는데요.

이 중 우측 상단에 있는 **Webhook** 를 선택합니다.

![webhook3](https://t1.daumcdn.net/cfile/tistory/9969803660177B510D)

그리고 원하시는 이벤트를 선택하여 **API Gateway주소와 슬랙 웹훅 주소** 를 등록합니다.

![webhook4](https://t1.daumcdn.net/cfile/tistory/99E9B44760177B510E)
...
![webhook5](https://t1.daumcdn.net/cfile/tistory/99A6314960177B510E)

여기까지 다 하셨다면!

이제 해당 채널에서는 코드리뷰가 추가/변경이 있을때마다 슬랙으로 알람을 받을 수 있게 됩니다.

![webhook6](https://t1.daumcdn.net/cfile/tistory/9954BD3960177B510E)

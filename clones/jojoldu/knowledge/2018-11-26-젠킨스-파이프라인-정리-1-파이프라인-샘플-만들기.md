---
topic: "젠킨스 파이프라인 정리 - 1. 파이프라인 샘플 만들기"
source_type: other
source_url: "https://jojoldu.tistory.com/355"
authorship: self
...
![plugin](https://t1.daumcdn.net/cfile/tistory/997A123D5BFB4AD927)

설치가 안되어있다면 설치하시고, 설치가 되셨다면 아래 내용을 진행하시면 됩니다.

먼저 젠킨스로 접속하셔서 새로운 item을 선택합니다.

![job1](https://t1.daumcdn.net/cfile/tistory/99345A465BFB4AD92D)

여기서 2번째인 Pipeline을 선택합니다.

![job2](https://t1.daumcdn.net/cfile/tistory/9974A8485BFB4AD92C)
...
![job3](https://t1.daumcdn.net/cfile/tistory/9990CD3B5BFB4AD92B)
...
![job4](https://t1.daumcdn.net/cfile/tistory/99262E425BFB4AD826)

그럼 작성한 코드의 `stage`에 작성된 이름이 Stage View에 표기됩니다.

그리고 각 스테이지에서 소요된 시간이 얼마나 되는지도 함께 표기됩니다.

![job5](https://t1.daumcdn.net/cfile/tistory/99F915435BFB4AD828)

각 스테이지별로 상세 로그가 보고 싶으시면 해당 스테이지를 클릭 -> Logs 버튼 클릭으로 볼 수 있습니다.

![job6](https://t1.daumcdn.net/cfile/tistory/999D0D475BFB4AD829)

성공할 경우 아래와 같이,

![job7](https://t1.daumcdn.net/cfile/tistory/998E23505BFB4AD81F)

실패했다면 아래와 같이 상세한 로그를 볼 수 있습니다.

![job8](https://t1.daumcdn.net/cfile/tistory/9978903E5BFB4AD81D)

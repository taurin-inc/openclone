---
topic: "Slack, Gmail의 북마크로 TickTick Task 만들기"
source_type: other
source_url: "https://jojoldu.tistory.com/823"
authorship: self
...
Gmail, Slack 등등에서 모두 플러그인 형태로 지원하는데, 이게 [오프라이트](https://www.offlight.work/ko) 를 몇개월간 사용해본 내 입장에서는 꽤나 불편했다.

---
topic: "3-1. 페이징 성능 개선하기 - 검색 버튼 사용시 페이지 건수 고정하기"
source_type: other
source_url: "https://jojoldu.tistory.com/530"
authorship: self
...
![count_no](https://t1.daumcdn.net/cfile/tistory/99277B4D5F9ECA120B)
...
![legacy_time](https://t1.daumcdn.net/cfile/tistory/9908974C5F9ECA1302)

(어떤 조회 환경에서는 **count 쿼리만 10초** 가 걸리기도 합니다.)

![simple_query](https://t1.daumcdn.net/cfile/tistory/990250355F9ECA130B)
...
![google_before](https://t1.daumcdn.net/cfile/tistory/99EC2A415F9ECA120A)

실제 페이지 버튼을 클릭해서 넘어가면 페이지 결과가 줄어드는 것을 볼 수 있는데요.

![google_after](https://t1.daumcdn.net/cfile/tistory/9932B1365F9ECA1202)
...
자렇게 됨으로써 "3. 전체 건수를 초과한 페이지 요청에는 마지막 페이지 결과 반환"에 대해서는 `FixedPageRequest` 클래스가 담당하게 되었으니 테스트 코드 역시 별도로 진행할 수 있게 되었습니다.
...
![dto-test-result](https://t1.daumcdn.net/cfile/tistory/992E41505F9ECA1301)
...
![search_btn_result](https://t1.daumcdn.net/cfile/tistory/998D45375F9ECA1308)
...
![page_btn_result](https://t1.daumcdn.net/cfile/tistory/99ED29415F9ECA130A)

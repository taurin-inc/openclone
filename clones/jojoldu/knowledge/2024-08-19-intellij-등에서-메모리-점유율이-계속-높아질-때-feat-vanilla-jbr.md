---
topic: "IntelliJ 등에서 메모리 점유율이 계속 높아질 때 (feat. vanilla JBR)"
source_type: other
source_url: "https://jojoldu.tistory.com/800"
authorship: self
...
[YouTrack](https://youtrack.jetbrains.com/) 이슈들을 확인 해보니, 이 이슈가 3년전부터 있었던 이슈였다.

---
topic: "Spring Batch ItemReader에서 Reader DB 사용하기 (feat. AWS Aurora)"
source_type: other
source_url: "https://jojoldu.tistory.com/506"
authorship: self
published_at: 2020-06-15
---
# Spring Batch ItemReader에서 Reader DB 사용하기 (feat. AWS Aurora)

by 향로 (기억보단 기록을) 2020. 6. 15.
...
![rds](https://t1.daumcdn.net/cfile/tistory/99256B345EE743A522)

Aurora를 클러스터 모드로 사용하게 되면 아래와 같이 Cluster Endpoint와 Reader용 EndPoint를 모두 제공합니다.

> EndPoint란 DB접근을 위한 URL이라고 보시면 됩니다

![cluster](https://t1.daumcdn.net/cfile/tistory/99B757455EE743A505)
...
![repository](https://t1.daumcdn.net/cfile/tistory/993CD1465EE743A518)
...
![batch-cluster](https://t1.daumcdn.net/cfile/tistory/99709E375EE743A52A)

이를 위해서 Datasource는 아래와 같은 구성이 됩니다.

![batch-datasource](https://t1.daumcdn.net/cfile/tistory/996694385EE743A524)
...
![doReadPage](https://t1.daumcdn.net/cfile/tistory/99A9873D5EE743A522)
...
![readerDataSource](https://t1.daumcdn.net/cfile/tistory/996C2B425EE743A518)
...
![emf](https://t1.daumcdn.net/cfile/tistory/9997E7505EE743A51B)
...
![HibernateJpaConfiguration](https://t1.daumcdn.net/cfile/tistory/990C2F3C5EE743A520)
...
![properties1](https://t1.daumcdn.net/cfile/tistory/992C404C5EE743A515)

위 코드를 추가할 경우 `provider_disables_autocommit` 옵션이 Spring 의 `auto-commit` 설정에 맞게 잘 적용되는 것을 확인할 수 있습니다.

![properties2](https://t1.daumcdn.net/cfile/tistory/9977F2345EE743A51A)
...
![readOnly-test-success](https://t1.daumcdn.net/cfile/tistory/99E50F435EE743A518)

예상한대로 테스트 코드가 통과됨을 확인할 수 있습니다.

### 3-2. Step 실행 및 DB 조회 검증
...
![batch-test-success1](https://t1.daumcdn.net/cfile/tistory/995D7C3E5EE743A51A)

Reader 쿼리 로그에도 정상적으로 요청이 간 것을 확인할 수 있습니다.

![batch-test-success2](https://t1.daumcdn.net/cfile/tistory/9982F23D5EE743A523)

---
topic: "Github Action & AWS Beanstalk 배포하기 - Github Action으로 빌드하기"
source_type: other
source_url: "https://jojoldu.tistory.com/543"
authorship: self
...
혹시나 제 저서를 보고 AWS Code Deploy를 사용해오셨다면, 좀 더 편하게 서버를 배포할 수 있는 AWS Beanstalk을 이번 기회로 한번 배워보시길 바래봅니다.
...
build가 끝나면, status가 Success를 볼 수 있습니다.

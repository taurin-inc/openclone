---
topic: "NodeJS에서 데이터베이스 통합 테스트 성능 개선하기 (TypeORM, Jest, PostgreSQL)"
source_type: other
source_url: "https://jojoldu.tistory.com/689"
authorship: self
...
![test-pyramid](https://blog.kakaocdn.net/dna/ba0elO/btrUuPYNyjg/AAAAAAAAAAAAAAAAAAAAAKSbVD7j5l4Tj9QFT7TF2_Xdak-FNFrRMKmnDWV0i9mo/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=QlUy95ikas3X7BITj6ouQcfhhLw%3D)
...
![new-1-origin](https://blog.kakaocdn.net/dna/cqx8IR/btrUulcbQFF/AAAAAAAAAAAAAAAAAAAAABGddMWggLylckOiFLAKvnDs2AIs56xrr0UTR1_MOmW5/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=OTHaEMVTuHOx2qhpKFhdMHL84is%3D)
...
![new-2-insert](https://blog.kakaocdn.net/dna/KIxSp/btrUDh61TmR/AAAAAAAAAAAAAAAAAAAAAM3IvgGRdAjVSSxbi6toAqVUQ9L4WQoRFu9xWmSvIdDf/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=LMCjenx572j%2FqW1swNjf6EznFzo%3D)
...
![new-2-swc](https://blog.kakaocdn.net/dna/d2OiAT/btrUuPEsFEp/AAAAAAAAAAAAAAAAAAAAANW6e6VORR3a3JTRXc29jI-2FntViO32MlB2MVfDDW3i/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=BqaOvE%2FHElyLaJuUio6H7AkrOUI%3D)
...
![new-2-tmpfs](https://blog.kakaocdn.net/dna/cpFw2d/btrUEvD0X00/AAAAAAAAAAAAAAAAAAAAALRVuNchdChee4msdJqhdzobZevlxl9IkbKA2z5FEDrz/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=jMNjf8E%2BuhU7bcfs%2BIJXIxlDXtA%3D)
...
![new-4-compare](https://blog.kakaocdn.net/dna/1fuGl/btrUAcdT5Rr/AAAAAAAAAAAAAAAAAAAAAJsMWD0sRDN0vUDuNO5RKMN5CVASh-uRlA0yyx0XsscK/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=oAlJcGJaAGD1KLcBwM21g5o8XSw%3D)
...
- [https://shusson.info/post/non-durable-postgres-for-e2e-tests](https://shusson.info/post/non-durable-postgres-for-e2e-tests)
...
- [https://www.postgresql.org/docs/13/non-durability.html](https://www.postgresql.org/docs/13/non-durability.html)
...
![new-3-non-durable1](https://blog.kakaocdn.net/dna/bU8KFq/btrUAbzha75/AAAAAAAAAAAAAAAAAAAAAEA_ZK3nprXu4J7BXb-guE8T23JkpE2vlTaaj8iML0FS/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=EXJcbESRKVk5tnUVbNQu641sWxg%3D)
...
beforeAll(async () => {
  ...
  await unloggedTable(getConnection()); // unlogged DDL

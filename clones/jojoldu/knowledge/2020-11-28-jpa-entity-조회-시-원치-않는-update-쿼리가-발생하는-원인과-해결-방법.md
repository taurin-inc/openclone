---
topic: "JPA Entity 조회 시 원치 않는 Update 쿼리가 발생하는 원인과 해결 방법"
source_type: other
source_url: "https://jojoldu.tistory.com/536"
authorship: self
...
![service](https://t1.daumcdn.net/cfile/tistory/99EFC0485FC225772E)

다음과 같이 select와 update 쿼리가 발생 하였습니다.

![select-update](https://t1.daumcdn.net/cfile/tistory/99CE3A4F5FC225772C)

신기한 것은 전체 컬럼에 대한 Update 쿼리가 발생한것입니다.

이렇게 **트랜잭션 내에서 Update 쿼리** 가 발생하면 보통은 [Dirty Checking](https://jojoldu.tistory.com/415) 이 발생했음을 **의심** 해볼만 한데요.
...
![logic1](https://t1.daumcdn.net/cfile/tistory/99AFD73A5FC225772C)
...
![logic2](https://t1.daumcdn.net/cfile/tistory/99554F335FC2257729)
...
![equals](https://t1.daumcdn.net/cfile/tistory/99BDCE495FC225772B)
...
![member](https://t1.daumcdn.net/cfile/tistory/999F25415FC225772E)

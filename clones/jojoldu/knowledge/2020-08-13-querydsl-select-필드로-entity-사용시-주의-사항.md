---
topic: "Querydsl Select 필드로 Entity 사용시 주의 사항"
source_type: other
source_url: "https://jojoldu.tistory.com/518"
authorship: self
...
아무래도 Querydsl로 추상화된 상태에서 쿼리를 작성하다보면 실제 어떻게 쿼리가 발생하는지 확인하지 않고 개발할때가 많습니다.

이를테면 쿼리 한번으로 해결하기 위해 select 필드에 Entity를 그대로 선언하는 경우가 바로 그런 경우인데요.
...
![erd](https://t1.daumcdn.net/cfile/tistory/991044405F352B1A22)
...
![query1](https://t1.daumcdn.net/cfile/tistory/99C5DA455F352B1A1A)
...
![result_entity](https://t1.daumcdn.net/cfile/tistory/990AA44F5F352B1A11)
...
![n+1_query](https://t1.daumcdn.net/cfile/tistory/995E4F3A5F352B1A18)
...
![query2](https://t1.daumcdn.net/cfile/tistory/99B026385F352B1A1D)

위 쿼리를 동일한 데이터 양에서 수행해보면?

![result_id](https://t1.daumcdn.net/cfile/tistory/992300475F352B1A21)
...
![test_result](https://t1.daumcdn.net/cfile/tistory/99B3A53C5F352B1916)

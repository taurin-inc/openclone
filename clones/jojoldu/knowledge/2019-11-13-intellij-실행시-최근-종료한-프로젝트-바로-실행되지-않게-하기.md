---
topic: "IntelliJ 실행시 최근 종료한 프로젝트 바로 실행되지 않게 하기"
source_type: other
source_url: "https://jojoldu.tistory.com/459"
authorship: self
published_at: 2019-11-13
---
# IntelliJ 실행시 최근 종료한 프로젝트 바로 실행되지 않게 하기

**향로 (기억보단 기록을)** | 2019. 11. 13.
...
![1](https://t1.daumcdn.net/cfile/tistory/99AE9E4A5DCB4A9820)

그래서 해당 설정을 진행해보겠습니다.

인텔리제이 좌측 상단의 IntelliJ IDEA -> Preferences (윈도우에선 Settings) 을 차례로 클릭합니다.

![2](https://t1.daumcdn.net/cfile/tistory/99F9BB3D5DCB4A9825)
...
![3](https://t1.daumcdn.net/cfile/tistory/9928C2495DCB4A9821)

그럼 처음 화면을 봤던것 처럼 매번 실행시마다 프로젝트 선택 화면이 등장합니다.

![1](https://t1.daumcdn.net/cfile/tistory/9918F7505DCB4A9823)

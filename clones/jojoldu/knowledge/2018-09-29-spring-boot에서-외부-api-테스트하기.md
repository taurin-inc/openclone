---
topic: "Spring Boot에서 외부 API 테스트하기"
source_type: other
source_url: "https://jojoldu.tistory.com/341"
authorship: self
...
![json파싱실패](https://t1.daumcdn.net/cfile/tistory/99F523475BAF16731F)
...
특히나 좋은 점은 `@RestClientTest`를 사용하면 `MockRestServiceServer`라는 임시 서버를 Bean으로 생성해주기 때문에 **원하는 형태의 요청이 오면 지정된 값으로 응답을 줄 수 있습니다**.
...
![테스트실패1](https://t1.daumcdn.net/cfile/tistory/9960B9425BAF167311)

그리고 이를 성공시키기 위해 `OrderDto`의 코드를 다음과 같이 변경하겠습니다.

![json포맷지정](https://t1.daumcdn.net/cfile/tistory/99443B3C5BAF16721F)

변경후 테스트를 실행해보시면!

![테스트성공1](https://t1.daumcdn.net/cfile/tistory/998D9A445BAF16731F)
...
![restTemplate](https://t1.daumcdn.net/cfile/tistory/992118445BAF167216)

---
topic: "커버링 인덱스 분석: WHERE, GROUP BY, ORDER BY 조합 및 활용 방법"
source_type: other
source_url: "https://jojoldu.tistory.com/481"
authorship: self
...
![desc-index](https://t1.daumcdn.net/cfile/tistory/99EA304A5E5A5E4006)
...
![where-order-1](https://t1.daumcdn.net/cfile/tistory/99B992345E5A5E402F)

GROUP BY와 마찬가지로 인덱스 컬럼 순서대로 진행되어서 별도로 `Using filesort` 가 없는 실행 계획이 나왔습니다.

실제로 쿼리를 수행해보면

![where-order-1-time](https://t1.daumcdn.net/cfile/tistory/990D4E505E5A5E402F)
...
![where-order-2](https://t1.daumcdn.net/cfile/tistory/9975444F5E5A5E401E)

그리고 실제로 실행해보면?

![where-order-2-time](https://t1.daumcdn.net/cfile/tistory/99BCE6445E5A5E4022)
...
![where-order-3](https://t1.daumcdn.net/cfile/tistory/99B3443E5E5A5E4128)

실제로 실행해보면?

수행 속도도 3.415초로 비슷한 성능이 발생합니다.

![where-order-3-time](https://t1.daumcdn.net/cfile/tistory/99CAB5425E5A5E4002)
...
![where-order-4](https://t1.daumcdn.net/cfile/tistory/9918A54F5E5A5E4005)

실제로 쿼리를 실행해보면

![where-order-4-time](https://t1.daumcdn.net/cfile/tistory/9932BA355E5A5E4033)
...
![group-order-1](https://t1.daumcdn.net/cfile/tistory/99F8E23B5E5A5E402B)

인덱스 컨디션 푸시다운 이 발동된것을 확인할 수 있습니다.

실제로 실행해보면?

![group-order-1-time](https://t1.daumcdn.net/cfile/tistory/9949A4405E5A5E4032)
...
![group-order-2](https://t1.daumcdn.net/cfile/tistory/99C560495E5A5E410F)

실제로 실행해보면?

![group-order-2-time](https://t1.daumcdn.net/cfile/tistory/992847365E5A5E412B)

---
topic: "Github Pull Request 시 Jest 및 Docker 테스트 자동화 구축하기"
source_type: other
source_url: "https://jojoldu.tistory.com/602"
authorship: self
...
![1](https://blog.kakaocdn.net/dna/dZMWYq/btrgxA7AfkA/AAAAAAAAAAAAAAAAAAAAADjxnlUBlekAfs8asEqQUgE89L1TXcr7bUJmHyIaVTBz/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=kjlXiiVCA%2BVUpa9OxJNOLAWNRyI%3D)
...
![step1-test-fail](https://blog.kakaocdn.net/dna/uFAys/btrgBlnNCLe/AAAAAAAAAAAAAAAAAAAAAK1C7-fELrOxuN8PHhTy8EKeU_sMLcC3UBdeCyvvnygJ/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=CCjsd95uBGYnZC1A8uK8jBn0QZA%3D)
...
![result1](https://blog.kakaocdn.net/dna/dheVsN/btrgB4lziYK/AAAAAAAAAAAAAAAAAAAAAGbC90k5krAe7Af_5-wAnD6UbqP_tB3YKc0NixzfRmfA/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=%2FT1Kmi6nJtkrndkMInDSAHRMxmo%3D)
![result2](https://blog.kakaocdn.net/dna/rDCpC/btrgC6QKf8s/AAAAAAAAAAAAAAAAAAAAAFZOEtNl8iUs0YKAle64ZgByTzm2TlM_-5bHpYZgn-4L/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=xsLOguA2W9Nka42gbYzmowr9EGM%3D)
...
웹훅 URL을 생성하셨다면, Repository Settings -> Secrets -> Actions 메뉴를 통해 등록합니다. 
Key값은 `SLACK_WEBHOOK_URL` 로 설정합니다.

최종 `pull-request.yml` 은 아래와 같습니다.
...
이렇게해서 마지막으로 Push를 해보시면, 슬랙 메세지가 전달되고 **결과 링크를 클릭하면 Github Action 수행 페이지로 바로 이동** 합니다.

![slack](https://blog.kakaocdn.net/dna/wTNGj/btrgxC5pqld/AAAAAAAAAAAAAAAAAAAAAC1zvN-nph48jCivBxXxzIOEnn7i1D2KyOfznyxu1hyk/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1769871599&allow_ip=&allow_referer=&signature=l%2BXejwptuykRTg3zG7QP1lCoEXY%3D)
